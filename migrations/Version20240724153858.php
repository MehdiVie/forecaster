 ...
 */
final class Version20240724153858 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO Location(name,country_code,latitude,longitude) VALUES ("Barcelona","ES",41.3874,2.1686)');

        $this->addSql('INSERT INTO Location(name,country_code,latitude,longitude) VALUES ("Berlin","DE",52.5200,13.4050)');

        $this->addSql('INSERT INTO Location(name,country_code,latitude,longitude) VALUES ("Paris","FR",48.8575,2.3514)');
